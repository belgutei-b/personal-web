...
- To compile a program, it needs some resources of the computer system. Who allocates this recourse? OS
...
1. Running
	...
	2. running -> ready state or Blocked
2. Ready
